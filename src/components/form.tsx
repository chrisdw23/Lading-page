...
export const Form = () => {
  ...
  return (
    <div className ='mb-[300px] absolute top-[-200px] left-0 right-0 mx-auto text center py-10 px-6 
    bg-Navy-850 rounded-[9px] w-[336px] md:w-[480px] xl:w-[920px]'>

        <h2 className='font-bold mb-4 text-[1.25rem]'>Get early access
        today</h2>
        <p className= 'text-sm mb-8'>It only takes a minute to sign up and our free
